...
public class SessionValue extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 159896884478121783L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"SessionValue\",\"namespace\":\"com.in.kafka.avro\",\"fields\":[{\"name\":\"sessionId\",\"type\":\"string\"}]}");
   ...
   */
  public SessionValue(java.lang.CharSequence sessionId) {
   ...
   */
  public static com.in.kafka.avro.SessionValue.Builder newBuilder() {
    return new com.in.kafka.avro.SessionValue.Builder();
  }
   ...
   * @return A new SessionValue RecordBuilder
   */
  public static com.in.kafka.avro.SessionValue.Builder newBuilder(com.in.kafka.avro.SessionValue.Builder other) {
    if (other == null) {
      return new com.in.kafka.avro.SessionValue.Builder();
    } else {
      return new com.in.kafka.avro.SessionValue.Builder(other);
    }
  }
   ...
   * @return A new SessionValue RecordBuilder
   */
  public static com.in.kafka.avro.SessionValue.Builder newBuilder(com.in.kafka.avro.SessionValue other) {
    if (other == null) {
      return new com.in.kafka.avro.SessionValue.Builder();
    } else {
      return new com.in.kafka.avro.SessionValue.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SessionValue>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.in.kafka.avro.SessionValue.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.in.kafka.avro.SessionValue other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.sessionId)) {
        this.sessionId = data().deepCopy(fields()[0].schema(), other.sessionId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.in.kafka.avro.SessionValue.Builder setSessionId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.in.kafka.avro.SessionValue.Builder clearSessionId() {
      sessionId = null;
