...
public class KafkaProducerConfig {
    ...
    public KafkaAdmin.NewTopics createTopics() {
        log.info("Creating topics: {}", AppConstants.RECENTLY_VIEWED_HISTORY_TOPIC);
        return new KafkaAdmin.NewTopics(
                new NewTopic(AppConstants.RECENTLY_VIEWED_HISTORY_TOPIC, 3, (short) 1)
        );
    }
    ...
    public ProducerFactory<String, Object> producerFactory() {
        ...
        configProps.put(ProducerConfig.ENABLE_IDEMPOTENCE_CONFIG, "true"); // prevents duplicate entries
